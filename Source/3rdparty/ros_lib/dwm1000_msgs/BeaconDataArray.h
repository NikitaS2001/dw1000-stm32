#ifndef _ROS_dwm1000_msgs_BeaconDataArray_h
#define _ROS_dwm1000_msgs_BeaconDataArray_h

#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
#include "dwm1000_msgs/BeaconData.h"
...
namespace dwm1000_msgs
{
  ...
  class BeaconDataArray : public ros::Msg
  {
    public:
      ...
      typedef dwm1000_msgs::BeaconData _beacons_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(beacons_lengthT > beacons_length)
        this->beacons = (dwm1000_msgs::BeaconData*)realloc(this->beacons, beacons_lengthT * sizeof(dwm1000_msgs::BeaconData));
      beacons_length = beacons_lengthT;
      for( uint32_t i = 0; i < beacons_length; i++){
      offset += this->st_beacons.deserialize(inbuffer + offset);
        memcpy( &(this->beacons[i]), &(this->st_beacons), sizeof(dwm1000_msgs::BeaconData));
      }
     return offset;
    }
